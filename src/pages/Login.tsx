...
function Login ({ navigate }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorMsg("Đã xảy ra lỗi kết nối hệ thống. Vui lòng thử lại.");
    } finally {
      setIsLoading(false);
    }
  };
...
<section className="auth-section mt-5">
  <div className="mt-4">
    ...
    <h2 className="mb-4 text-center h5 font-weight-bold text-secondary">
      Đăng nhập tài khoản RivoraMart
    </h2>
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="text-end">
        <button className="btn btn-primary btn-block font-weight-bold px-4" type="submit" disabled={isLoading}>
