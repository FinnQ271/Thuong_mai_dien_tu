...
$(function () {
  // Safe fallback for Vercel/static deploys: do not crash if a plugin CDN/file is unavailable.
  if (!$.fn.owlCarousel) {
    console.warn("Owl Carousel plugin is not loaded. Slider initialization skipped.");
    $.fn.owlCarousel = function () { return this; };
  }

  if (!$.fn.niceSelect) {
    console.warn("Nice Select plugin is not loaded. Select styling skipped.");
